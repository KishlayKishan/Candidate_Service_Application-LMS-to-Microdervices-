    ...
    public List<CombinedResponseDTO> getAll() {
        ...
        if (getCandidates.isEmpty()) {
            ...
            for (int i = 1; i <= candidateRepository.count(); i++) {
                ...
                Object candidateInfo = restTemplate.getForObject("http://localhost:9012/candidateDetails/get/" + i, Object.class);
                combinedResponseDTO.setCandidate(candidateInfo);
                //        get Qualification details
                Object qualificationInfoList = restTemplate.getForObject("http://localhost:9011/qualification/getby/" + i, Object.class);
...
//        get BankInfo details
    ...
    public void deletebyId(long id) {
        ...
        if (candidate.isPresent()) {
            //        get Qualification details
            Object qualificationInfoList = restTemplate.getForObject("http://localhost:9011/qualification/deleteBy/" + id, Object.class);
            //        get BankInfo details
            Object bankInfoList = restTemplate.getForObject("http://localhost:9010/bankinfo/delete/" + id, Object.class);
